        ...
        React.createElement('button', {
          ...
          React.createElement('div', { className: "flex items-center space-x-4" },
            React.createElement('div', { className: "flex-shrink-0 bg-indigo-100 p-3 rounded-full" },
               React.createElement('svg', { className: "h-6 w-6 text-indigo-600", xmlns: "http://www.w.org/2000/svg", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", 'aria-hidden': "true" },
        ...
        React.createElement('button', {
          ...
          React.createElement('div', { className: "flex items-center space-x-4" },
            React.createElement('div', { className: "flex-shrink-0 bg-teal-100 p-3 rounded-full" },
              React.createElement('svg', { className: "h-6 w-6 text-teal-600", xmlns: "http://www.w.org/2000/svg", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", 'aria-hidden': "true" },
